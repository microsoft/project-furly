...
namespace Furly.Exceptions
{
    ...
    public class TemporarilyBusyException : Exception, ITransientException
    {
        ...
        /// <inheritdoc />
        public TemporarilyBusyException(string message) : base(message)
        {
        }

        /// <inheritdoc />
        public TemporarilyBusyException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
}
