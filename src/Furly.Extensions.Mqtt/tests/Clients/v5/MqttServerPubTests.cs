...
namespace Furly.Extensions.Mqtt.Clients.v5
{
    ...
    public sealed class MqttServerPubTests : IDisposable
    {
        private readonly MqttServerFixture _server;
        private readonly MqttClientHarness _harness;

        public MqttServerPubTests(MqttServerFixture server, ITestOutputHelper output)
        {
            _server = server;
        ...
        public async Task SendEventTest1Async()
        {
            ...
            var eventClient = _server.Publisher;
