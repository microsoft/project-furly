...
<body>Don't forget me this weekend!</body>
            ...
            var result = Default.FromObject(expected);
        ...
        {
            var expected = Default.FromArray((byte)1, (byte)2, (byte)3);
            var o1 = expected.ConvertTo<byte[]>();
            var json = Newtonsoft.SerializeToString(o1);
        ...
        {
            var expected = Default.FromObject(o).ConvertTo(type);
            var actual = Newtonsoft.FromObject(o).ConvertTo(type);
        ...
        {
            var expected = Default.FromObject(v);
            var actual = Newtonsoft.FromObject(v);
        ...
        {
            var expected = Default.FromObject(new
            {
                Test = "Text",
                Locale = "de"
            });
            var actual = Newtonsoft.FromObject(new
            {
                Test = "Text",
                Locale = "de"
            });
        ...
        public void SerializerFromObjectContainerToContainerWithObject()
        {
            ...
            {
                Value = Default.FromObject(new
                {
                    Test = "Text",
                    Locale = "de"
                })
            };
            var tmp = Newtonsoft.FromObject(expected);
