...
namespace Microsoft.Azure.Devices.Edge.Util.Edged.Version20200707.GeneratedCode
{
#pragma warning disable // Disable all warnings
    ...
    public partial class HttpWorkloadClient
    {
        ...
        /// <returns>Ok</returns>
        /// <exception cref="IoTEdgedException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<ManifestTrustBundleResponse> ManifestTrustBundleAsync(string api_version)
        {
            return ManifestTrustBundleAsync(api_version, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="IoTEdgedException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<ManifestTrustBundleResponse> ManifestTrustBundleAsync(string api_version, System.Threading.CancellationToken cancellationToken)
        {
            if (api_version == null)
                throw new System.ArgumentNullException("api_version");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/manifest-trust-bundle?");
            urlBuilder_.Append("api-version=").Append(System.Net.WebUtility.UrlEncode(ConvertToString(api_version, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(ManifestTrustBundleResponse);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<ManifestTrustBundleResponse>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
                        ...
                        return default(ManifestTrustBundleResponse);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.4.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class ManifestTrustBundleResponse : System.ComponentModel.INotifyPropertyChanged
    {
        private string _certificate;
        ...
        public static ManifestTrustBundleResponse FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ManifestTrustBundleResponse>(data);
        }
