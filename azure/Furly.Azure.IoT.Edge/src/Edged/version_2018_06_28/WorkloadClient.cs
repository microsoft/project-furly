...
namespace Microsoft.Azure.Devices.Edge.Util.Edged.Version20180628
{
    using Microsoft.Azure.Devices.Edge.Util.Edged.Version20180628.GeneratedCode;
    ...
    {
        /// <inheritdoc/>
        public WorkloadClient(IHttpClientFactory factory, Uri serverUri, ApiVersion apiVersion, string moduleId, string moduleGenerationId)
